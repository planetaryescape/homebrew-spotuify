class Spotuify < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.arm?
      ...
      sha256 "0ddfd7ae7ad425a430b5781867e73d486dd2c8f149553482dc1283272b9bed75"
    else
      url "https://github.com/planetaryescape/spotuify/releases/download/v#{version}/spotuify-v#{version}-macos-x86_64.tar.gz"
      sha256 "8a752c04137f12e6ea56b981dc43ddb5a58f0ac25821f70023b2247dbedef698"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "d4bfb602b75b2d96f2ce05c80175efad8cd7906eb7ff3d9ae69d8a8a58ca154e"
    end
  end
